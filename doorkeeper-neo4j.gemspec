...
require 'doorkeeper/neo4j/version'

Gem::Specification.new do |spec|
  spec.name          = "doorkeeper-neo4j"
  spec.version       = Doorkeeper::Neo4j::VERSION
  spec.authors       = ["Michael De Lorenzo"]
  spec.email         = ["michael@delorenzodesign.com"]
